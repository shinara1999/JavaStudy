		...
		String[] title={
			...
			38,7,7,15,15
			 ...
			 for(int i=0;i<title.length;i++)
			 {
				 ...
				 System.out.println((i+1)+"."+id+" "+title[i]+" "+singer[i]+" "+album[i]);
			 }
			 System.out.println("==========================================================================================");
			 
			 // 1. 순위가 가장 많이 상승한 노래의 제목, 가수명을 출력하시오. 
			 ...
			 for(int i=0;i<title.length;i++)
			 {
				 ...
				 {
					 System.out.println(title[i]+" "+singer[i]); // 제목 , 가수 출력할 때도 for문 돌리기
				 }
			 }
			 System.out.println("==========================================================================================");
			 
			 // 노래명중에 가장 긴 제목의 노래와 가수명 , 앨범명을 출력하시오. (다시해보기)
			 int max2=0;
			 for(int i=0;i<title.length;i++)
			 {
				 if(title[i].length()>max2)
				 {
					 max2=title[i].length();
				 }
			 }
			 ...
			 System.out.println(title[i]+" "+singer[i]+" "+album[i]);
			 System.out.println("==========================================================================================");
			 ...
			 System.out.println("하강한 노래의 갯수:"+count+"개");
			 System.out.println("==========================================================================================");
			 ...
			 System.out.println("임영웅 노래의 총 갯수:"+count+"개");
			 System.out.println("==========================================================================================");
			 
			 // 검색어를 입력받아서 => 검색어가 포함되어있는 노래명
			 System.out.print("검색어 입력:");
			 String tt=scan.next();
			 
			 for(i=0;i<title.length;i++)
			 {
				 if(title[i].contains(tt))
				 {
					 System.out.println(title[i]);
				 }
			 }
