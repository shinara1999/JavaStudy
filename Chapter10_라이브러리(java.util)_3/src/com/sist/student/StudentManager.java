...
public class StudentManager {
	...
	{
		list.add(new Student(1, "주찬양", 90, 45, 87));
		list.add(new Student(2, "최종수", 80, 67, 97));
		list.add(new Student(3, "성준수", 30, 58, 60));
		list.add(new Student(4, "전영중", 76, 67, 65));
		list.add(new Student(5, "기상호", 90, 80, 89));
	}
