 		...
 		------ 모든 프로그램에 한개 이상 존재
 		  ...
 		  => 사용자 정의 쓰레드
 		  		...
 		  		=> 방법 1
 		  		 ...
 		  		 => 방법 3
 		  		 	익명의 함수 () => run : 람다식 (메소드명 없이 사용 => 코딩이 간결하다.)
 		  		 		단점 : 재사용 (객체지향을 벗어난다.)
 		  		 		Runnable r=()->{
 		  		 			구현 
 		  		 		} 
 		  ...
 		  쓰레드 생성	============> 대기 (쓰레드 필요한 자원 확보) ===> 쓰레드 동작 ======> 일시정지 sleep()
 		  														   ㅣ 
 		  											      쓰레드 종료 interrupt()
 		  => start()     => run() 수행
 		  => sleep()     => 일시정지
